...
const MatriculaForm = ({ onNombreCargado, estudianteIdFijo, fechaLimiteBD }) => {
    ...
    return (
        <div className="container">
            ...
            <form onSubmit={gestionarMatricula}>
                ...
                {/* 🛡️ PARTE 1: INTERCAMBIO ATÓMICO DE LA SECCIÓN DE SELECTORES */}
                {alumnoYaMatriculado ? (
                    /* 🏷️ EL AVISO DE TAMANIO RELATIVO SOLICITADO: Reemplaza a los selectores si ya está matriculado */
                    <div style={{
                        width: 'auto',
                        ...
                        {/* Check de verificación estilizado */}
